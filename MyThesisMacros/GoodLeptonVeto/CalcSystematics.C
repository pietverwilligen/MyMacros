...
void CalcSystematics() {
  ...
  tot.push_back(2136);    tot.push_back(337);     tot.push_back(72);     tot.push_back(22);     tot.push_back(16);

  barrel.push_back(1436); barrel.push_back(213);  barrel.push_back(51);  barrel.push_back(15);  barrel.push_back(12);
  endcap.push_back(700);  endcap.push_back(124);  endcap.push_back(21);  endcap.push_back(7);   endcap.push_back(4);

  barlow.push_back(561);  barlow.push_back(62);   barlow.push_back(1);   barlow.push_back(0);   barlow.push_back(0); 
  barhigh.push_back(875); barhigh.push_back(151); barhigh.push_back(50); barhigh.push_back(15); barhigh.push_back(12);
  endlow.push_back(313);  endlow.push_back(47);   endlow.push_back(1);   endlow.push_back(0);   endlow.push_back(0);
  endhigh.push_back(387); endhigh.push_back(77);  endhigh.push_back(20); endhigh.push_back(7);  endhigh.push_back(4);
  ...
  */
  ...
  std::cout<<" Photon + 2 Jet Sel: YIELD = "<<tot[0]<<" stat = "<<stat[0]<<" CORR = "<<j2_val  <<" syst = "<<j2_err  <<" PRED = "<<tot[0] * j2_val  <<" stat = "<<stat[0] * j2_val  <<" syst = "<<tot[0] * j2_val   * j2_err  <<std::endl;
  std::cout<<" Photon + 3 Jet Sel: YIELD = "<<tot[1]<<" stat = "<<stat[1]<<" CORR = "<<j3_val  <<" syst = "<<j3_err  <<" PRED = "<<tot[1] * j3_val  <<" stat = "<<stat[1] * j3_val  <<" syst = "<<tot[1] * j3_val   * j3_err  <<std::endl;
  std::cout<<" Baseline Selection: YIELD = "<<tot[2]<<" stat = "<<stat[2]<<" CORR = "<<base_val<<" syst = "<<base_err<<" PRED = "<<tot[2] * base_val<<" stat = "<<stat[2] * base_val<<" syst = "<<tot[2] * base_val * base_err<<std::endl;
  std::cout<<" High HT  Selection: YIELD = "<<tot[3]<<" stat = "<<stat[3]<<" CORR = "<<hht_val <<" syst = "<<hht_err <<" PRED = "<<tot[3] * hht_val <<" stat = "<<stat[3] * hht_val <<" syst = "<<tot[3]  * hht_val  * hht_err<<std::endl;
  std::cout<<" High MHT Selection: YIELD = "<<tot[4]<<" stat = "<<stat[4]<<" CORR = "<<mht_val <<" syst = "<<mht_err <<" PRED = "<<tot[4] * mht_val <<" stat = "<<stat[4] * mht_val <<" syst = "<<tot[4]  * mht_val  * mht_err<<std::endl;

  std::cout<<""<<std::endl;
  std::cout<<"Theor Uncertanty: 10% RMS"<<std::endl;
  std::cout<<""<<std::endl;
