...
void Acceptance3_AA_AllPlots() {

  std::string SelHistos [] = {"Boson_0J_AA/Pt", "Boson_1J_AA/Pt", "Boson_2J_AA/Pt", "Boson_3J_AA/Pt", "Boson_0J_AA/Eta", "Boson_1J_AA/Eta", "Boson_2J_AA/Eta", "Boson_3J_AA/Eta"};
  std::string NameHistos[] = {"Boson_0J_AA_Pt", "Boson_1J_AA_Pt", "Boson_2J_AA_Pt", "Boson_3J_AA_Pt", "Boson_0J_AA_Eta", "Boson_1J_AA_Eta", "Boson_2J_AA_Eta", "Boson_3J_AA_Eta"};
  ...
  for (int ii=0; ii<8; ++ii) {
    ...
    P1i = ((TH1F*) file_P1->Get("NJets")); P1a = P1i->GetEntries();
    P2i = ((TH1F*) file_P2->Get("NJets")); P2a = P2i->GetEntries();
    P3i = ((TH1F*) file_P3->Get("NJets")); P3a = P3i->GetEntries();
