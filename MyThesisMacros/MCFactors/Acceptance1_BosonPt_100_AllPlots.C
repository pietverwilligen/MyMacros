...
void Acceptance1_BosonPt_100_AllPlots() {

  std::string SelHistos [] = {"Boson_0J_BA_100/Pt", "Boson_1J_BA_100/Pt", "Boson_2J_BA_100/Pt", "Boson_3J_BA_100/Pt", "Boson_0J_BA_100/Eta", "Boson_1J_BA_100/Eta", "Boson_2J_BA_100/Eta", "Boson_3J_BA_100/Eta"};
  std::string NameHistos[] = {"Boson_0J_BA_100_Pt", "Boson_1J_BA_100_Pt", "Boson_2J_BA_100_Pt", "Boson_3J_BA_100_Pt", "Boson_0J_BA_100_Eta", "Boson_1J_BA_100_Eta", "Boson_2J_BA_100_Eta", "Boson_3J_BA_100_Eta"};

  std::vector<std::string> Histos; for(int i=0;i<8; ++i) { Histos.push_back(SelHistos[i]); }
  std::vector<std::string> Names;  for(int i=0;i<8; ++i) {  Names.push_back(NameHistos[i]); }
  ...
  for (int ii=0; ii<8; ++ii) {
    ...
    P1 = ((TH1F*) file_P1->Get(SelHisto.c_str())); P1_ = (TH1F*) P1->Clone();
    P2 = ((TH1F*) file_P2->Get(SelHisto.c_str())); P2_ = (TH1F*) P2->Clone();
    P3 = ((TH1F*) file_P3->Get(SelHisto.c_str())); P3_ = (TH1F*) P3->Clone();
    Zb = ((TH1F*) file_Zb->Get(SelHisto.c_str())); Zb_ = (TH1F*) Zb->Clone();
    // Final Histograms
