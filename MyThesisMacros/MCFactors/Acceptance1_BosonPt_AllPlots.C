...
void Acceptance1_BosonPt_AllPlots() {

  std::string SelHistos [] = {"Boson_0J_BA/Pt", "Boson_1J_BA/Pt", "Boson_2J_BA/Pt", "Boson_3J_BA/Pt", "Boson_0J_BA/Eta", "Boson_1J_BA/Eta", "Boson_2J_BA/Eta", "Boson_3J_BA/Eta"};
  std::string NameHistos[] = {"Boson_0J_BA_Pt", "Boson_1J_BA_Pt", "Boson_2J_BA_Pt", "Boson_3J_BA_Pt", "Boson_0J_BA_Eta", "Boson_1J_BA_Eta", "Boson_2J_BA_Eta", "Boson_3J_BA_Eta"};
  ...
  for (int ii=0; ii<8; ++ii) {
	...
	std::cout<<"Bin "<<j<<" ZB value = "<<ZB->GetBinContent(j)<<" ZB error = "<<ZB->GetBinError(j)<<" PH value = "<<PH->GetBinContent(j)<<" PH error = "<<PH->GetBinError(j)<<std::endl;
      }
      for(int j=41; j<45; ++j) {
