...
void ZinvTurnOn() {
  ...
  std::string XaxisHisto    = "Z boson PT [GeV/c]";
  std::string YaxisHisto    = "Events / 5 GeV/c";
  std::string NameHistos[]  = {"MC_Z_AMC_Efficiency", "MC_Z_HHS_Efficiency", "MC_Z_HMS_Efficiency"};
 ...
 for (int ii=0; ii<entries; ++ii) {
   ...
   Z_num->SetLineColor(1);
   Z_num->SetLineStyle(1);
   Z_num->SetLineWidth(2);
   Z_den->SetLineColor(2);
   Z_den->SetLineStyle(2);
   Z_den->SetLineWidth(2);
    ...
    if(!rebin) {
      ...
      c1->cd();
      c1->SetLogy(1);
      Z_den->GetYaxis()->SetRangeUser(3e-4,1e4);      
      ...
      Z_den->GetYaxis()->SetTitle(yaxis.c_str());
      Z_den->GetYaxis()->SetLabelSize(0.025);
      // A->GetYaxis()->SetTicks("+");
      // A->GetXaxis()->SetTitle(xaxis.c_str())
      Z_den->GetXaxis()->SetLabelSize(0.0000025);
      Z_den->GetXaxis()->SetTicks("+-");
      Z_den->Draw("HIST");
      Z_num->Draw("HISTsame");
      // D->Draw("sameE");
      // Z->Draw("sameH");
      ...
      l1->SetBorderSize(0);
      l1->AddEntry(Z_den, "Z boson PT Before MHT Cut","l");
      l1->AddEntry(Z_num, "Z boson PT After MHT Cut","l");
      l1->Draw();
      cmsPrelim(lumi,-1);
      c1->SetLogy(1);
      double r = 0.4;
      ...
      ratioPad->SetGridy();
      TH1* ratio = 0;
      ratio = (TH1F*)Z_num->Clone();
      ratio->Divide(Z_num, Z_den, 1, 1, "b");
