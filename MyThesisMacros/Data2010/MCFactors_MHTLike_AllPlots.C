...
void MCFactors_MHTLike_AllPlots() {
  ...
  std::string NameHistos[]  = {"Boson_HT_All", "Boson_MHT_All", "Boson_HT_AJC", "Boson_MHT_AJC", "Boson_HT_AHC", "Boson_MHT_AHC", "Boson_HT_AAC", "Boson_MHT_AAC", "Boson_HT_AMC", "Boson_MHT_AMC", "Boson_HT_HHS", "Boson_MHT_HHS", "Boson_HT_HMS", "Boson_MHT_HMS"};
