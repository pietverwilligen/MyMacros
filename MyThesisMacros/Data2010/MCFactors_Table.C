...
void MCFactors_Table() {
  ...
  TH1F * P1ra2 = ((TH1F*) file_P1->Get("EventCounters_B000")); P1ra2->Sumw2(); P1ra2->Scale(scaling[0]); 
  TH1F * P2ra2 = ((TH1F*) file_P2->Get("EventCounters_B000")); P2ra2->Sumw2(); P2ra2->Scale(scaling[1]); 
  TH1F * P3ra2 = ((TH1F*) file_P3->Get("EventCounters_B000")); P3ra2->Sumw2(); P3ra2->Scale(scaling[2]);
