...
void PTurnOn() {
  ...
  for (int ii=0; ii<entries; ++ii) {
    ...
    TH1F * P1_num = ((TH1F*) file_P1->Get((dir+NumHisto).c_str()));
    TH1F * P2_num = ((TH1F*) file_P2->Get((dir+NumHisto).c_str()));
    TH1F * P3_num = ((TH1F*) file_P3->Get((dir+NumHisto).c_str()));
    TH1F * Zb_num = ((TH1F*) file_Zb->Get((dir+NumHisto).c_str()));
    TH1F * P1_denom = ((TH1F*) file_P1->Get((dir+DenomHisto).c_str()));
    TH1F * P2_denom = ((TH1F*) file_P2->Get((dir+DenomHisto).c_str()));
    TH1F * P3_denom = ((TH1F*) file_P3->Get((dir+DenomHisto).c_str()));
    TH1F * Zb_denom = ((TH1F*) file_Zb->Get((dir+DenomHisto).c_str()));
    ...
    PH_num->GetYaxis()->SetRangeUser(3e-3,3e3);
