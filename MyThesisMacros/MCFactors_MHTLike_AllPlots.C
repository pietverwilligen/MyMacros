...
void MCFactors_MHTLike_AllPlots() {

  int entries = 14; // !!! Aanpassen !!!
  std::string dir = "RA2SEL/";
  std::string SelHistos[]   = {"0_HT_All", "0_MHT_All", "1_HT_AJC", "1_MHT_AJC", "2_HT_AHC", "2_MHT_AHC", "3_HT_AAC", "3_MHT_AAC", "4_HT_AMC", "4_MHT_AMC", "6_HT_HHS", "6_MHT_HHS", "7_HT_HMS", "7_MHT_HMS"};
  std::string XaxisHisto[] = {"HT [GeV/c]", "MHT [GeV/c]","HT [GeV/c]", "MHT [GeV/c]","HT [GeV/c]", "MHT [GeV/c]","HT [GeV/c]", "MHT [GeV/c]","HT [GeV/c]", "MHT [GeV/c]", "HT [GeV/c]", "MHT [GeV/c]","HT [GeV/c]", "MHT [GeV/c]"};
  std::string YaxisHisto[] = {"All Events / 5 GeV/c", "All Events / 5 GeV/c","Events after Jet cut / 5 GeV/c", "Events after Jet cut / 5 GeV/c","Events after HT cut / 5 GeV/c", "Events after HT cut / 5GeV/c","Events after Angular cut / 5 GeV/c", "Events after Angular cut / 5 GeV/c","Events after MHT cut / 5 GeV/c", "Events after MHT cut / 5 GeV/c", "Events in High HT Selection / 5 GeV/c", "Events in High HT Selection / 5 GeV/c", "Events in High MHT Selection / 5 GeV/c", "Events in High MHT Selection / 5 GeV/c"};
  std::string NameHistos[]  = {"HT_All", "MHT_All", "HT_AJC", "MHT_AJC", "HT_AHC", "MHT_AHC", "HT_AAC", "MHT_AAC", "HT_AMC", "MHT_AMC", "HT_HHS", "MHT_HHS", "HT_HMS", "MHT_HMS"};
  ...
  for (int ii=0; ii<entries; ++ii) {
    ...
    TH1F * PH = new TH1F("PH", "PH", 44, ptbinning); PH->Sumw2();
    TH1F * ZB = new TH1F("ZB", "ZB", 44, ptbinning); ZB->Sumw2();
    ...
    for(int j=1; j<=20; ++j) {PH->SetBinContent(j,0); PH->SetBinError(j,0); ZB->SetBinContent(j,0); ZB->SetBinError(j,0);}
    ...
    PH->GetYaxis()->SetRangeUser(3e-2,3e2);
